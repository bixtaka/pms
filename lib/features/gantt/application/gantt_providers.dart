...
class ProcessSpecData {
  ...
  const ProcessSpecData({required this.groups, required this.steps});
}
...
final ganttProcessSpecProvider =
    FutureProvider.family<ProcessSpecData, Project>((ref, project) async {
...
final productGanttBarsProvider = FutureProvider.autoDispose
    .family<List<ProductGanttBar>, Project>((ref, project) async {
      ...
      return service.buildBarsFromDaily(daily, productQuantities: qtyMap);
    });
